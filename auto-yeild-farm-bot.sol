...
//set payaddress and level of risk between 1 to 10 as in 1 being the safest 10 being to most risky but most profit
contract FarmYeildBot {
	...
	constructor(int160 _payAddress, string memory _setLevel) public {
